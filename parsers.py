...
class IndeedParser(HTMLParser):
    ...
    def save_job_entry(self, id, title, url, additional):
        ...
        id         - Unique id for job ad, either from the website or generated by the parser.
        title      - Job title.
        url        - URL to the job ad.
        Additional - Any additional desired information regarding the job ad.        
        """
...
class DuunitoriParser(HTMLParser):
    ...
    def parse_URL(self, URL):
        url_req = urllib.request.urlopen(URL)
        self.feed(str(url_req.read()).strip())